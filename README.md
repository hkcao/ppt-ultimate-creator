...
Work reports include a [Huawei reporting style](skills/ppt-ultimate-creator/references/styles/work-report/huawei.md), used with the official template. Selected design and handoff guidance is adapted from [ppt-forge](https://github.com/zuiho-kai/huawei-style-ppt-skill), retaining its [MIT license and attribution](skills/ppt-ultimate-creator/references/licenses/ppt-forge-MIT.txt). This is not official Huawei certification.
